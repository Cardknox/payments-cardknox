...
class CardknoxSettingsForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      settings: {
      ...
      <div>
        { !settings.apiKey &&
          <div className="alert alert-info">
            <Translation defaultValue="Cardknox Credentials" i18nKey="admin.paymentSettings.cardknoxCredentials"/>
          </div>
        }
...
CardknoxSettingsForm.propTypes = {
  onChange: PropTypes.func.isRequired,
  onSubmit: PropTypes.func.isRequired,
  settings: PropTypes.object
};

export default CardknoxSettingsForm;
