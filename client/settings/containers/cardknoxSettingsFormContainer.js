...
import { CardknoxSettingsForm } from "../components";

class CardknoxSettingsFormContainer extends Component {
  constructor(props) {
    super(props);
...
CardknoxSettingsFormContainer.propTypes = {
...
export default composeWithTracker(composer)(CardknoxSettingsFormContainer);
